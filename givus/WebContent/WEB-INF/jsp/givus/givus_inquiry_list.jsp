	...
	<table width="980" style="margin:auto;" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="830px" height="860px" class="notice_body" valign="top" align="center"> 				
				...
				<tr>
					<td height="25px" class="right_subtitle"><img src="${imageHandler.g_right_subtitle_icon}"> 1:1 문의</td>
				</tr>
				<tr>
					<td class="right_table" width="830px">
						...
						<table>
							...
							<tr class="right_table_data">
								<td colspan=8 class="right_table_data" style="text-align: center;padding:30px">문의한 내역이 없습니다.</td>
							</tr>
							</c:if>
				...
				<tr>
					<td colspan=12 style="text-align: right;padding-top:5px"><a href="${contextPath}/___/p/inquiry/create"><img src="${imageHandler.g_right_write}"></a></td>
				</tr>
				<tr>
