...
<table style="margin:0 auto;">
	<tr>
		...
		<td valign="top">
	<jsp:include page="/WEB-INF/jsp/givus/${body_page}.jsp"/>
		</td>
		<%-- SIDE MENU RIGHT --%>
		<td width="130" valign="top"><jsp:include page="/WEB-INF/jsp/givus/givus_sidebar_left.jsp"/></td>
	</tr>
</table>
</div>

<jsp:include page="/WEB-INF/jsp/givus/givus_footer.jsp"/>
