				...
				<tr>
					<td>
						<ul class="left-menu">
							...
							<c:if test="${ hospitalId > 0 || userType=='M'}">
							<li>쪽지함
								<ul class="left-submenu">
									<li><a href="${contextPath}/___/p/msg/create/${pageType}"> - 쪽지쓰기</a></li>
									<li><a href="${contextPath}/___/p/msg/receive/${pageType}"> - 받은쪽지함</a></li>
						...
						<table border="0" cellspacing="0" cellpadding="0"  class="property-list">
							...
							<tr>
								...
								<tr>
									...
									<td class="right-data">
										<span class="right-value"><form:password path="${head.name}1" cssClass="right-input-text" size="30" hint=""/>
										&nbsp;비밀번호를 다시 한 번 입력하여 주십시오.
										</span>
									</td>
								</tr>
						</c:forEach> 
