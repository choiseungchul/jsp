...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td align="center">
	...
	<table width="980" style="margin:auto;" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td class="body_title_desc" align="left">GIVUS 서비스 신규, 업데이트 및 여러가지 소식들을 알려드립니다.</td>
		</tr>
		<tr>
			...
			<td width="830px" height="860px" class="notice_body" valign="top" align="center"> 				
				...
				<tr>
					<td height="25px" class="right_subtitle"><img src="${imageHandler.g_right_subtitle_icon}"> 공지사항</td>
				</tr>
				<tr>
