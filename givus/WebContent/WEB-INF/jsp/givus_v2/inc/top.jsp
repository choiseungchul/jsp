...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 $(function(){
	 $('.menu ul li').mouseenter(function(e){
		 $('.menu ul li:not(.sub)').removeClass('on');
 ...
 <div class="top_bg">
	<div class="site_top">
		<div class="left site_top_logo">
			...
			<%
			if(um.getEmail() != null){
				if(um.getUserType().toString().equals("M")){
				%>
				<a href="${contextPath}/admin_main.jsp" target="_blank">관리자페이지</a>
			<%
...
<div class="menu_wrap">	
	<div class="menu">
		<ul>
			...
			<%			
				if(um.getEmail() != null){
					if(um.getUserType().equals("G") || um.getUserType().equals("M")){
			%>
			...
			<%		
						...
						if(status.equals("A")){
			%>
				<li class="m7"><a href="${contextPath }/___/renew/mypage/myhinfo">병원페이지</a></li>
			<%
